...
var hideThree = document.querySelector('.fortune-three');

var startOver = document.querySelector('.button');
...
function wrapper() {
  ...
  var textChangeTwo = function textChangeTwo() {
    hideTwo.style.display = "none";
...
var showFortune = fortuneAPI[0].message;

function fortunate() {
  window.alert(showFortune);
  location.reload();
};
...
three.addEventListener('click', fortunate);